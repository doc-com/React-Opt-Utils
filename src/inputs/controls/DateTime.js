...
const validateDateTime = (value, datePattern, range, occurrences, translate) => {
...
const DateTime = (props) => (
    <FastField name={props.path}
               validate={(value) => {
                   return validateDateTime(value, props.control.datePattern, props.control.range, props.control.occurrences, props.translate)
               }}
               render={
                   ({field, form}) => {
                                   ...
                                   <KeyboardDateTimePicker
                                       ...
                                       onError={error => {
                                           ...
                                           if (error !== currentError) {
                                               let err = _.get(form.touched, props.path) ? validateDateTime(field.value, props.control.datePattern, props.control.range, props.control.occurrences, props.translate) : '';
